        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-2 justify-between">
          {
            posts && posts.length > 0 ? (
              ...
              <div className="text-center col-span-full text-gray-950 mx-auto dark:text-gray-100 dark:bg-gray-700 my-3 p-8">No posts found</div>
            )
          }
