        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 w-full">
          <div className="col-span-2 mx-auto flex flex-col gap-2">
            <div className="text-center italic max-w-[400px] max-h-[250px] flex justify-center items-center text-xl text-gray-500 dark:text-gray-400 border-2 border-gray-400 dark:border-gray-400 rounded-md">
              ...
              {/* Image preview */}
              <img src={viewImage ? viewImage : pictureHolder} className="w-full h-full object-cover" alt="Post picture holder" />
            </div>
          ...
          <Menu as="div" className="relative inline-block text-left col-span-2">
            <div>
              <MenuButton className="inline-flex w-full justify-center gap-x-1.5 rounded-md bg-transparent px-3 py-2 text-sm font-semibold text-gray-900 dark:text-white ring-1 shadow-xs ring-gray-300 ring-inset hover:bg-gray-700">
