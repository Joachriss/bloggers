...
export const TrendyPost = (props:any) => {
  return (
    <div className='overflow-hidden rounded-lg relative w-full max-h-80'>
        <img src={`http://localhost:8000/uploads/images/${props.image}`} className="scale-150" alt="Trend picture holder" />
