...
export const CommentForm = (props: any) => {
    ...
    return (
        <div className="max-w-4xl mb-2 mt-1">
            ...
            <button type="submit" onClick={handleComment} className="p-2 bg-green-700 duration-100 hover:bg-gray-800 shadow-lg text-white rounded-lg mt-2 flex ms-auto">Comment</button>
        </div>
    )
}
